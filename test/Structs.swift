...
print("La placa del carro: ", newCarro.placa)
print("El color del carro: ", newCarro.color)
print("El tipo del carro: ", newCarro.tipo)

newCarro.placa = "P2343"

print("La nueva placa del carro: ", newCarro.placa)
/*
